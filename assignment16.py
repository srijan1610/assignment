...
conn.execute("INSERT INTO COMPANY (ID,NAME,AGE,ADDRESS,SALARY) VALUES(1,'STRILING',21,'CALIFORNIA',20000.00)")
conn.execute("INSERT INTO COMPANY (ID,NAME,AGE,ADDRESS,SALARY) VALUES(2,'SRIJAN',20,'CALIFORNIA',210000.00)")
conn.commit()
